	...
	if(args[0] === "usd") {
		...
		.end(function(result) {
		  ...
		  let embed = new Discord.RichEmbed()
				...
				.addField(`Bitcoin Quantity:`, result.body[0].price_btc, true)
				...
				.setFooter(`Developed by: Eric#1997 and Flakfired#1337 using Discord.js: v${Discord.version} and Node: ${process.version}.`)
